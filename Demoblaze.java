...
public class Demoblaze {
    ...
    public void Register() throws InterruptedException {
        ...
        Thread.sleep(3000);
        driver.findElement(By.id("sign-username")).sendKeys("Tatiana999");
        driver.findElement(By.id("sign-password")).sendKeys("something");
    ...
    public void Login() throws InterruptedException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("sign-username")).sendKeys("Tatiana999");
        driver.findElement(By.cssSelector("#loginpassword")).sendKeys("something");
    ...
    public void CompleteCheckout() throws InterruptedException {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("name")).sendKeys("Tatiana");
